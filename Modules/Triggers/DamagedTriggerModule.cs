...
namespace BloonFactory.Modules.Triggers
{
    internal class DamagedTriggerModule : TriggerModule
    {
        ...
        public override void ProcessModule()
        {
            ...
            currentModel.AddBehavior(new OnDamagedTriggerModel("OnDamagedTriggerModel", guids, GetValue<float>("Cooldown"), GetValue<int>("Chance") / 100, false, Il2Cpp.BloonProperties.None));
