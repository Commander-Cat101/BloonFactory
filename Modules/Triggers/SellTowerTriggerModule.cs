...
{
    internal class SellTowerTriggerModule : TriggerModule
    {
        public override string Name => "Sell Tower Trigger";
        ...
        public override void ProcessModule()
        {
            ...
            currentModel.AddBehavior(new SellTriggerModel("SellTriggerModel", guids));
